...
// 生成配置文件的 CF 优选 IP
const bestCFIP = "dns.dns2one.pp.ua"

// 用于 CF 网站的代理 IP
const proxyIPs = ["edgetunnel.anycast.eu.org"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
